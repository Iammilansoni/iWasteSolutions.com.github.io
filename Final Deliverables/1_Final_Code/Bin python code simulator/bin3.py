...
while True:
    ...
    if distance < 15:
          dist = 'Risk warning:' 'Dustbin poundage getting high, Time to collect :) 90 %'
        
                
    elif distance < 40 and distance >16:
          dist = 'Risk warning:' 'dustbin is above 60%'
    ...
    if load == "90 %" or distance == "90 %":
          warn  = 'alert :' 'Risk Warning: Dustbin poundage getting high, Time to collect :)'
                
    elif load == "60 %" or distance == "60 %":
                
          warn = 'alert :' 'dustbin is above 60%'
    else :
